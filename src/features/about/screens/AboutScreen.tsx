      ...
      >
        ...
        <View style={styles.section}>
          ...
          >
            <Text style={[styles.descText, { color: theme.black }]}>
              A university project that aggregates news from The Guardian API
              and displays them in one organized platform. Users can browse by
              category, search, save articles, and manage their account.
            </Text>
          </View>
        </View>
            ...
            {FEATURES.map((f, index) => (
              <View key={f.title}>
                <View style={styles.featureRow}>
                  ...
                  <Text style={[styles.featureTitle, { color: theme.black }]}>
                    {f.title}
                  </Text>
                </View>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
            onPress={() =>
              Linking.openURL("https://open-platform.theguardian.com/")
            }
          >
            <View
              style={[styles.iconBox, { backgroundColor: theme.lightGray }]}
            >
              <MaterialCommunityIcons
                name="api"
                size={18}
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.sourceDesc, { color: theme.gray }]}>
